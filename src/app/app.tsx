  ...
  return (
    <div class="bg-indigo-950 h-full py-5">
      <header class="w-full place-content-center flex px-5">
        <span
          class="text-sky-400 text-3xl sm:text-4xl font-extrabold leading-none tracking-tight text-center mb-5">Копировалка</span>
      </header>
      <Navigation/>
      ...
      <footer class="border-t border-gray-200 dark:border-gray-700 flex flex-row justify-center justify-items-center pt-4">
        <a class="[&>svg]:h-5 [&>svg]:w-5" href="https://t.me/StephanYorchenko" target="_blank">
          <svg
